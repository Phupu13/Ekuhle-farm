...
<div class="wrap">
    <div class="container">
        <div class="row justify-content-between">
                ...
                <p class="mb-0 d-flex">
                        <a href="#" class="d-flex align-items-center justify-content-center"><span class="fa fa-user"><?php echo $user['fname']." ".$user['lname'];?></i></span></a>
...
<div class="container">
    <a class="navbar-brand" href="farmerPage.php">Ekuhle Online <span>Store</span></a>
  ...
  <div class="collapse navbar-collapse" id="ftco-nav">
    <ul class="navbar-nav m-auto">
        <li class="nav-item active"><a href="farmerPage.php" class="nav-link">Home</a></li>
